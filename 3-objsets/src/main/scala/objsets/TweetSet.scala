...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = all.filter(tweet => google.exists(x => tweet.text.contains(x)))
  lazy val appleTweets: TweetSet = all.filter(tweet => apple.exists(x => tweet.text.contains(x)))
